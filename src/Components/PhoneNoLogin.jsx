...
import { RecaptchaVerifier, signInWithPhoneNumber } from "firebase/auth";
import { toast, Toaster } from "react-hot-toast";
import styles from './phonenologin.module.css'; // Import the CSS module
...
const App = (props) => {
  ...
  return (
    <section className={`${styles.loginSection} d-flex align-items-center justify-content-center`}>
      <div>
        <div id="recaptcha-container"></div>

        <div className={`${styles.formContainer} d-flex flex-column gap-4 rounded-lg p-4`}>
          {showOTP ? (
            <div className={`${styles.otpBox} ${styles.bgDarkTransparent} rounded`}>
              <label htmlFor="otp" className={`font-weight-bold text-xl text-center ${styles.textLight}`}>
                Enter your OTP
              </label>
              <OtpInput
                value={otp}
            ...
            <div className={`${styles.loginBox} ${styles.bgDarkTransparent} rounded`}>
              <label htmlFor="aadhaar" className={`font-weight-bold text-xl text-center ${styles.textLight}`}>
                Enter your Aadhaar Number
              </label>
              <input
                placeholder="Enter Aadhaar Number"
